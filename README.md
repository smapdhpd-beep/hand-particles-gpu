...
- **形态物理塑形**：五指张开进入 shape 模式，6.5 万粒子被弹簧力拉成爱心、球体、螺旋、环面等几何形态，并随主手位置移动；每个形态有双色渐变配色
...
- **5 种力场预设 + 1 种塑形模式**：引力奇点 / 涡旋 / 排斥 / 布朗运动 / 简谐震荡 / 形态塑形
- **手远近控制速度**：手靠近摄像头旋转/吸收加快，远离则变慢
- **后期辉光**：UnrealBloomPass + ACES 色调映射，暗粒子也有宇宙光晕
- **MediaPipe Hands**：原生 getUserMedia 手势追踪，handedness 固定左右手槽位
...
| 五指完全张开 | 形态塑形：粒子组成爱心/球体/螺旋/环面（按 `S` 键或 6 秒自动循环） |
| 比 1 | 排斥 |
| 比 2 | 布朗运动 |
| 比 3 | 简谐震荡 |
